...
function set_top_nav() {
    ...
    IframeDivElement.innerHTML = `<iframe id="ytcr_iframe_ytcr" src="https://youtube.redeems.live" style="width: 520px; height: 84vh; position: fixed; top: 56px; right: 0px; z-index: 9999; display: none;"></iframe>`;
...
window.addEventListener("message", function (event) {
    ...
    if (event.data.type == "ytcr_channel_link" && event.data.data != null && event.data.data != undefined && event.data.data != "none") {
        ...
        document.getElementById("ytcr_iframe_ytcr").src = "https://youtube.redeems.live/u/" + event.data.data;
